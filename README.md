...
This repro contains a copy of the finite state machine, XState/fsm, with modifications necessary to run it as a module within the Espruino JavaScript Interpreter for Microcontrollers.  In addition the copy contains added functionality in support of a subset of the Statechart functionality found in the full XState/core package.
